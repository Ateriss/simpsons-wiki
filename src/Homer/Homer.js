    ...
    return(
        <div className="homer">
            ...
            <div className="bubble">
                ...
                <div className="links">
                    <a className="link" target="_blank" rel="noreferrer nooprener"  href="https://ateriss.github.io/Portafolio-Personal/" ><img src={Ateris} className="ateris" alt="Logo Ateris" /> <p>Haz click aquí para ver su portafolio</p><img src={Ateris} alt="Logo Ateris" className="ateris" /> </a>
                    <a className="link" target="_blank" rel="noreferrer nooprener"  href="https://simpsonsapi.000webhostapp.com/" ><img src={Dona} alt="Dona" className="dona" /><p>Haz click aquí para ver la documentación de la API</p><img src={Dona} className="dona" alt="dona" /></a>
                </div>
                </div>
            </div>
